    ...
    <div className="bg-gray-100 py-10 px-4">
      <form className="bg-white max-w-xl mx-auto p-6 rounded-lg shadow space-y-6">
        ...
        <div>
          ...
          <input type="file" onChange={(e) => handleImageUpload(e, setBgImage)} className="w-full" />
          {bgImage && <img src={bgImage} alt="Background" className="w-full h-32 object-cover mt-2 rounded" />}
        </div>
